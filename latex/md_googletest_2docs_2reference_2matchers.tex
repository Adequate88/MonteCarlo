...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md257}{}\doxysection{\texorpdfstring{Container Matchers}{Container Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md257}
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md258}{}\doxysection{\texorpdfstring{Member Matchers}{Member Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md258}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md259}{}\doxysection{\texorpdfstring{Matching the Result of a Function, Functor, or Callback}{Matching the Result of a Function, Functor, or Callback}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md259}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md260}{}\doxysection{\texorpdfstring{Pointer Matchers}{Pointer Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md260}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md261}{}\doxysection{\texorpdfstring{Composite Matchers}{Composite Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md261}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md262}{}\doxysection{\texorpdfstring{Adapters for Matchers}{Adapters for Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md262}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md263}{}\doxysection{\texorpdfstring{Defining Matchers}{Defining Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md263}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
