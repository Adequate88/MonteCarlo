...
std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{class_a_s_t_node}{ASTNode}} $>$ make\+Func (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{name}{, }\item[{std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{class_a_s_t_node}{ASTNode}} $>$}]{arg}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{class_a_s_t_node}{ASTNode}} $>$ make\+Op (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{op}{, }\item[{std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{class_a_s_t_node}{ASTNode}} $>$}]{left}{, }\item[{std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{class_a_s_t_node}{ASTNode}} $>$}]{right}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
std\+::vector$<$ \mbox{\hyperlink{struct_token}{Token}} $>$ tokenize (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{expr}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
